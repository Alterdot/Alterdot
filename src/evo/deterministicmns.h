...
#ifndef ADOT_DETERMINISTICMNS_H
#define ADOT_DETERMINISTICMNS_H
...
public:
    ...
    bool ProcessBlock(const CBlock& block, const uint256& blockHash, const CBlockIndex* pindex, CValidationState& state, bool fJustCheck);
