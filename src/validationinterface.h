...
protected:
    ...
    virtual void BlockChecked(const CBlock&, const uint256&, const CValidationState&) {}
...
struct CMainSignals {
    ...
    boost::signals2::signal<void (const CBlock&, const uint256&, const CValidationState&)> BlockChecked;
