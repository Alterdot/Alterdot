...
#define BOOST_TEST_MODULE Alterdot Test Suite

#include "test_alterdot.h"
...
TestingSetup::TestingSetup(const std::string& chainName) : BasicTestingSetup(chainName)
{
    const CChainParams& chainparams = Params();
        ...
        ClearDatadirCache();
        pathTemp = GetTempPath() / strprintf("test_alterdot_%lu_%i", (unsigned long)GetTime(), (int)(GetRand(100000)));
